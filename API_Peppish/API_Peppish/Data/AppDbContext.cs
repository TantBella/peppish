    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HouseholdJoinRequest>(entity =>
            {
                ...
                entity.Property(e => e.JoinCodeId)
                    .IsRequired();
            ...
            modelBuilder.Entity<ChoreAssignment>(entity =>
            {
                ...
                entity.Property(e => e.ChoreTemplateId)
                    .IsRequired();
            ...
            modelBuilder.Entity<AvatarProgress>(entity =>
            {
                ...
                entity.Property(e => e.DailyProgressPercent)
                    .IsRequired()
                    .HasDefaultValue(0);
                ...
                .IsUnique()
                .HasDatabaseName(
                    "IX_AvatarProgress_Household_User_Unique");
            });
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                .HasDatabaseName(
                    "IX_Notification_User_CreatedAt");
            });
        }
    }
}